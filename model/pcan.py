...
sys.path.append('./')
sys.path.append('../')
from .recognizer.tps_spatial_transformer_original import TPSSpatialTransformer
from .recognizer.stn_head_original import STNHead
...
class PCAN(nn.Module):
    ...
    def forward(self, x):
        ...
        # output = torch.tanh(self.block8(x6+x))
